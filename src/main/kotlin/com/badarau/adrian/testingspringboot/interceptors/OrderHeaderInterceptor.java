...
package com.badarau.adrian.testingspringboot.interceptors;
...
import com.badarau.adrian.testingspringboot.events.BeerOrderStatusChangeEvent;
...
public class OrderHeaderInterceptor extends EmptyInterceptor {
    ...
    Logger log = LoggerFactory.getLogger(OrderHeaderInterceptor.class);
